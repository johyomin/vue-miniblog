...
const actions = {
  fetchReadMemo(context) {
    axios.get('http://johyomin.dothome.co.kr/page_miniblog/read.php')
      .then(response => {
  ...
  fetchAddMemo(context, obj) {
    ...
    axios.get(`http://johyomin.dothome.co.kr/page_miniblog/write.php?user=${addData.user}&title=${addData.title}&date=${addData.date}&icon=${addData.icon}`)
      .then(response => {
        // console.log(response.data);
  ...
  fetchDeleteMemo({
    ...
    axios.get(`http://johyomin.dothome.co.kr/page_miniblog/delete.php?id=${obj.id}`)
    .then(response => {
  ...
  fetchUpdateMemo({
    ...
    axios.get(`http://johyomin.dothome.co.kr/page_miniblog/update.php?id=${obj.item.id}&complete=${complete}`)
    .then(response => {
  ...
  fetchClearMemo({
    ...
    // 정상적으로 처리되었다면
    // 아래를 실행한다.
    axios.get("http://johyomin.dothome.co.kr/page_miniblog/delete.php?id=all")
    .then(response => {
...
const mutations = {
  ...
  ADD_MEMO(state, payload) {
    ...
    axios.get(`http://johyomin.dothome.co.kr/page_miniblog/get.php?user=${payload.user}`)
    .then(response => {
